...
test: test-server test-ad-server
.PHONY: test
...
test-ad-server: build-ad-server
	CONTAINER_CMD=$(CONTAINER_CMD) LOCAL_TAG=$(AD_SERVER_NAME) hack/test-samba-ad-container.sh
.PHONY: test-ad-server
